/**Есть бд с людьми, их студ билетами, почтами и списками оценок, также содержится информация
о группах, принадлежности к ним студентов, их старостах и предметах для этих групп
Программа выволит всех, потом для каждого выводит список студентов, далее считает срение баллы,
и ввыводит учеников с средними баллом больше 4
выполнил Тараканов Борис НПИбд-02-21*/
